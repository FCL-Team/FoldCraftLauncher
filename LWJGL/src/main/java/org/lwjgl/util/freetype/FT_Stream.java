...
public class FT_Stream extends Struct<FT_Stream> implements NativeResource {
    ...
    public static class Buffer extends StructBuffer<FT_Stream, Buffer> implements NativeResource {
        ...
        /** Sets the address of the specified {@link ByteBuffer} to the {@code base} field. */
        public Buffer base(@Nullable @NativeType("unsigned char *") ByteBuffer value) { FT_Stream.nbase(address(), value); return this; }
        /** Sets the specified value to the {@code size} field. */
        public Buffer size(@NativeType("unsigned long") long value) { FT_Stream.nsize(address(), value); return this; }
        /** Sets the specified value to the {@code pos} field. */
        public Buffer pos(@NativeType("unsigned long") long value) { FT_Stream.npos(address(), value); return this; }
        /** Copies the specified {@link FT_StreamDesc} to the {@code descriptor} field. */
        public Buffer descriptor(FT_StreamDesc value) { FT_Stream.ndescriptor(address(), value); return this; }
        /** Passes the {@code descriptor} field to the specified {@link java.util.function.Consumer Consumer}. */
        public Buffer descriptor(java.util.function.Consumer<FT_StreamDesc> consumer) { consumer.accept(descriptor()); return this; }
        /** Copies the specified {@link FT_StreamDesc} to the {@code pathname} field. */
        public Buffer pathname(FT_StreamDesc value) { FT_Stream.npathname(address(), value); return this; }
        /** Passes the {@code pathname} field to the specified {@link java.util.function.Consumer Consumer}. */
        public Buffer pathname(java.util.function.Consumer<FT_StreamDesc> consumer) { consumer.accept(pathname()); return this; }
        /** Sets the specified value to the {@code read} field. */
        public Buffer read(@Nullable @NativeType("FT_Stream_IoFunc") FT_Stream_IoFuncI value) { FT_Stream.nread(address(), value); return this; }
        /** Sets the specified value to the {@code close} field. */
        public Buffer close$(@Nullable @NativeType("FT_Stream_CloseFunc") FT_Stream_CloseFuncI value) { FT_Stream.nclose$(address(), value); return this; }
