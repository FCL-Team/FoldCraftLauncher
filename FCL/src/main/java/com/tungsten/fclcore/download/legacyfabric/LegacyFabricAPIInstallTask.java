...
/**
 * <b>Note</b>: Legacy Fabric should be installed first.
 */
public final class LegacyFabricAPIInstallTask extends Task<Version> {
    ...
    public void execute() throws IOException {
        dependencies.add(new FileDownloadTask(
                new URL(remote.getVersion().file().url()),
                dependencyManager.getGameRepository().getRunDirectory(version.getId()).toPath().resolve("mods").resolve("legacy-fabric-api-" + remote.getVersion().version() + ".jar").toFile(),
