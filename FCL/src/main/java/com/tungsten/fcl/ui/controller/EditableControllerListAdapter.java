...
public class EditableControllerListAdapter extends FCLAdapter {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        viewHolder.parent.setBackground(controller == ((ControllerManagePage) UIManager.getInstance().getControllerUI().getPage(ControllerUI.PAGE_ID_CONTROLLER_MANAGER)).getSelectedController() ? getContext().getDrawable(R.drawable.bg_container_transparent_selected) : getContext().getDrawable(R.drawable.bg_container_transparent_clickable));
        ...
        viewHolder.parent.setOnClickListener(view1 -> {
            ((ControllerManagePage) UIManager.getInstance().getControllerUI().getPage(ControllerUI.PAGE_ID_CONTROLLER_MANAGER)).setSelectedController(controller);
        ...
        viewHolder.delete.setOnClickListener(view1 -> {
            ...
            builder.setPositiveButton(() -> ((ControllerManagePage) UIManager.getInstance().getControllerUI().getPage(ControllerUI.PAGE_ID_CONTROLLER_MANAGER)).removeController(controller));
