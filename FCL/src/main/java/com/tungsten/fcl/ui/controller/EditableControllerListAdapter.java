...
public class EditableControllerListAdapter extends FCLAdapter {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        viewHolder.parent.setBackground(controller == UIManager.getInstance().getControllerUI().getSelectedController() ? getContext().getDrawable(R.drawable.bg_container_transparent_selected) : getContext().getDrawable(R.drawable.bg_container_transparent_clickable));
        ...
        viewHolder.parent.setOnClickListener(view1 -> {
            UIManager.getInstance().getControllerUI().setSelectedController(controller);
        ...
        viewHolder.delete.setOnClickListener(view1 -> {
            ...
            builder.setPositiveButton(() -> UIManager.getInstance().getControllerUI().removeController(controller));
