...
//        mHeight = 1.0f;
    ...
    public void surfaceChanged(){
        ...
        surfaceChanged(null, 0, SDLActivity.getContext().getResources().getDisplayMetrics().widthPixels, SDLActivity.getContext().getResources().getDisplayMetrics().heightPixels);
    }
