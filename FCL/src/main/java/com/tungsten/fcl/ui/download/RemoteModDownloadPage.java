...
public class RemoteModDownloadPage extends FCLTempPage {
    ...
    public RemoteModDownloadPage(Context context, int id, FCLUILayout parent, int resId, List<RemoteMod.Version> list, Profile.ProfileVersion version, @Nullable RemoteModDownloadPage.DownloadCallback callback) {
    ...
    public void onStart() {
        ...
        ModVersionAdapter adapter = new ModVersionAdapter(getContext(), list, new ModVersionAdapter.Callback() {
            @Override
            public void saveAs(RemoteMod.Version version) {
                RemoteModDownloadPage.this.saveAs(version);
            }

            @Override
            public void onItemSelect(RemoteMod.Version version) {
                download(version);
            }
        });
