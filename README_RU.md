...
- [control-converter](https://github.com/NingZeStudio/control-converter) (конвертер раскладок управления FCL→ZL2, реализация на rust, упакован как `libcc.so`): [MIT License](https://opensource.org/licenses/MIT)
